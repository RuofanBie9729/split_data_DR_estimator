...
Phi_hat <- function(a, Trials, Target){
  ...
  hat_p_crt_fit_rf <- randomForest(as.formula(paste0("R~", cpt_covariates)), data=Trial_whole, mtry=4) 
  hat_p_crt_rf <- sapply(predict(hat_p_crt_fit_rf, newdata=Whole), expit)
  ...
  ea_crt_fit_rf <- randomForest(as.formula(paste0("R~", cpt_covariates)), data=Trial, mtry=4)
  ea_crt_rf <- sapply(predict(ea_crt_fit_rf, newdata=Whole), expit) 
  ...
  pr_fit_rf <- randomForest(as.formula(paste0("R~", cpt_covariates)), data=Trial_arm, mtry=4)
  pr_rf <- predict(pr_fit_rf, Whole, type="response")
...
DR_split <- function(a, Trials, Target){
  ...
  hat_p_crt_S2 <- sapply(predict(hat_p_crt_fit_S1, newdata=Whole_S2), expit)
  ...
  hat_p_crt_S1 <- sapply(predict(hat_p_crt_fit_S2, newdata=Whole_S1), expit)
  ...
  hat_p_crt_rf_S2 <- sapply(predict(hat_p_crt_fit_rf_S1, newdata=Whole_S2), expit)
  ...
  hat_p_crt_rf_S1 <- sapply(predict(hat_p_crt_fit_rf_S2, newdata=Whole_S1), expit)
  ...
  ea_crt_S2 <- sapply(predict(ea_crt_fit_S1, newdata=Whole_S2), expit) 
  ea_crt_fit_rf_S1 <- randomForest(as.formula(paste0("R~", cpt_covariates)), data=Trial_S1, mtry=4)
  ea_crt_rf_S2 <- sapply(predict(ea_crt_fit_rf_S1, newdata=Whole_S2), expit) 
  ...
  ea_crt_S1 <- sapply(predict(ea_crt_fit_S2, newdata=Whole_S1), expit) 
  ea_crt_fit_rf_S2 <- randomForest(as.formula(paste0("R~", cpt_covariates)), data=Trial_S2, mtry=4)
  ea_crt_rf_S1 <- sapply(predict(ea_crt_fit_rf_S2, newdata=Whole_S1), expit) 
  ...
  pr_S2 <- sapply(predict(pr_fit_S1, Whole_S2), expit)
  pr_fit_rf_S1 <- randomForest(as.formula(paste0("R~", cpt_covariates)), data=Trial_arm_S1, mtry=4)
  pr_rf_S2 <- sapply(predict(pr_fit_rf_S1, Whole_S2), expit)
  ...
  pr_S1 <- sapply(predict(pr_fit_S2, Whole_S1), expit)
  pr_fit_rf_S2 <- randomForest(as.formula(paste0("R~", cpt_covariates)), data=Trial_arm_S2, mtry=4)
  pr_rf_S1 <- sapply(predict(pr_fit_rf_S2, Whole_S1), expit)
...
saveRDS(results, "hat_p_misspecified_n500.rds")
